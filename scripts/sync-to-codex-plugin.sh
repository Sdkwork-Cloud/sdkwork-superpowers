...
Upstream commit: https://github.com/Sdkwork-Cloud/sdkwork-superpowers/commit/$UPSTREAM_SHA
...
Upstream: https://github.com/Sdkwork-Cloud/sdkwork-superpowers/commit/$UPSTREAM_SHA
Branch:   $SYNC_BRANCH"
